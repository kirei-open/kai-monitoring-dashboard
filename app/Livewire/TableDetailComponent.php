...
class TableDetailComponent extends Component
{
    ...
    public function render()
    {
        ...
        $locations = Location::selectRaw('*, ST_X(point::geometry) AS longitude, ST_Y(point::geometry) AS latitude')->where('device_id', $this->id)->get(); 
        $measurements = Measurement::where('device_id', $this->id)->get();
