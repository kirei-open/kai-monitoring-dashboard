                  ...
                  e.map((e) =>
                      (function (e) {
                          return new Promise((t, o) => {
                              ...
                              i.addEventListener("load", t.bind(e), {
                                  once: !0,
                              }),
                                  (i.src = e),
    ...
    function n(e, t) {
        let [o, i] = (function (e) {
                let t = L.latLngBounds(
                        [
                            e.getElementsByTagName("south")[0].childNodes[0]
                                .nodeValue,
                            e.getElementsByTagName("west")[0].childNodes[0]
                                .nodeValue,
                        ],
                        [
                            e.getElementsByTagName("north")[0].childNodes[0]
                                .nodeValue,
                            e.getElementsByTagName("east")[0].childNodes[0]
                                .nodeValue,
                        ]
                    ),
                    o = e.getElementsByTagName("rotation")[0];
                return (
                    void 0 !== o && (o = parseFloat(o.childNodes[0].nodeValue)),
                    [t, o]
                );
    ...
    const a = (L.KMZLayer = L.FeatureGroup.extend({
        ...
        parse: function (e, t) {
            return (
                ...
                "PK" ===
                String.fromCharCode(
                    new Uint8Array(o, 0, 1),
                    new Uint8Array(o, 1, 1)
                )
                    ? this._parseKMZ(e, t)
                    : this._parseKML(e, t)
            );
        ...
        _parseKML: function (e, t) {
            var o = r(e),
                i = (function (e, t) {
                    ...
                    return (
                        (i.properties = L.extend({}, i.properties, t || {})), i
                    );
                })(o, t),
                n = (
                    this.options.geometryToLayer || this._geometryToLayer
                ).call(this, i, o);
            this.addLayer(n),
                ...
                r = L.geoJson(e, {
                    ...
                    style: (e) => {
                        ...
                        return (
                            ...
                            o["stroke-opacity"] &&
                                (t.opacity = o["stroke-opacity"]),
                            o["fill-opacity"] &&
                                (t.fillOpacity = o["fill-opacity"]),
                            o["stroke-width"] &&
                                (t.weight = 1.05 * o["stroke-width"]),
                            t
                        );
                    },
                    onEachFeature: (e, t) => {
