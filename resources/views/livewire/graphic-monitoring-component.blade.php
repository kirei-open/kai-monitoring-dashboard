<div>
  <h1 class="text-[#a4a2b4] lg:mt-[110px] lg:ml-[60px] lg:text-[20px]">GRAPHIC MONITORING</h1>
  <div class="grid grid-cols-2 gap-1">
    ...
    {{-- <div class="bg-white rounded-lg shadow dark:bg-gray-800 lg:ml-[60px] lg:w-[870px] lg:mt-7" style="position: relative;">
      ...
      <div id="chart-3" class="px-2.5 lg:mt-[-100px]"></div>
    </div> --}}
  ...
  <script>
    ...
    function updateData2() {
      const newData = Array.from({ length: 9 }, () => Math.floor(Math.random() * 100));
      if (document.getElementById("chart-2") && typeof ApexCharts !== 'undefined') {
        const chart = new ApexCharts(document.getElementById("chart-2"), {
          colors: ['#ef732f'],
          series: [{
            name: "Humidity",
            data: newData
