<div>
  ...
  <section class="lg:mt-[7rem] lg:ml-[325px]">
      <!-- Modal toggle -->
      <button data-modal-target="static-modal" data-modal-toggle="static-modal"  type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Generate Report</button>
      <!-- Main modal -->
          ...
          <div class="relative p-4 w-full max-w-2xl max-h-full">
              ...
              <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                  ...
                  <div class="flex items-center">
                    <label for="select devices" class="block lg:mt-[-40px] lg:ml-6 text-sm font-medium 
                            text-gray-900 dark:text-white">
                            Filter Data By Date
                    </label>
                    <div class="relative mt-12 lg:ml-[-120px]">
                      <input wire:model="startDate" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 
                            ...
                            dark:focus:border-blue-500 lg:w-[200px]"
                            type="datetime-local" name="startDate">
                            
                    </div>
                    <span class="mx-4 text-gray-500 mt-12">To</span>
                    <div class="relative mt-12">
                      <input wire:model="endDate" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 
                              focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 
                              dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 
                              dark:focus:border-blue-500 lg:w-[200px]"
                  ...
                  <div class="flex items-center p-4 md:p-5 rounded-b dark:border-gray-600">
                      <button data-modal-hide="static-modal" wire:click="createReport" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Generate</button>
