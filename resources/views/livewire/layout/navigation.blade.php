  ...
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-30 lg:mx-[12.5rem] lg:mt-[-20px] p-4">
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
      @if (auth()->user()->hasRole(['Teknisi']))
        <ul class="flex flex-col p-4 md:p-0 mt-2 font-medium border border-gray-100 rounded-lg bg-gray-50 
          ...
          <li class="{{ Request::is('graphic') ? 'bg-blue-100 text-blue-800 font-medium dark:bg-blue-900 
              dark:text-blue-300' : 'dark:text-white' }} text-[16px] px-4 py-3 rounded-full hover:bg-blue-100 
            ...
            <x-dropdown align="right" width="48">
              <x-slot name="trigger">
                <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 
                  ...
                  <div class="lg:text-[16px] text-[13px] hover:text-[#193766] hover:font-bold" 
                        x-data="{ name: '{{ ucfirst(auth()->user()->name) }}' }"
                        x-text="name" 
      ...
      @if (auth()->user()->hasRole(['super_admin']))
        <ul class="flex flex-col p-4 md:p-0 mt-2 font-medium border border-gray-100 rounded-lg 
          ...
          <li class="{{ Request::is('dashboard') ? 'bg-blue-100 text-blue-800 font-medium dark:bg-blue-900 
              dark:text-blue-300' : 'dark:text-white' }} text-[16px] px-4 py-3 rounded-full hover:bg-blue-100 
              hover:text-blue-800 hover:dark:bg-blue-900 hover:dark:text-blue-300">
              <a href="{{ route('dashboard') }}">Home</a>
          </li>
          <li class="{{ Request::is('table') ? 'bg-blue-100 text-blue-800 font-medium dark:bg-blue-900 
              dark:text-blue-300' : 'dark:text-white' }} text-[16px] px-4 py-3 rounded-full hover:bg-blue-100 
              hover:text-blue-800 hover:dark:bg-blue-900 
              hover:dark:text-blue-300">
          ...
          <li class="{{ Request::is('event-logger') ? 'bg-blue-100 text-blue-800 font-medium dark:bg-blue-900 
              dark:text-blue-300' : 'dark:text-white' }} text-[16px] px-4 py-3 rounded-full hover:bg-blue-100 
              hover:text-blue-800 hover:dark:bg-blue-900 
              hover:dark:text-blue-300">
