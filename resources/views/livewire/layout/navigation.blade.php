...
<nav id="nav" class="bg-white z-10 fixed top-0 flex-no-wrap w-full py-2 dark:bg-gray-900">
  <div
    class="max-w-screen-2xl flex flex-wrap items-center justify-between mx-30 lg:mx-[12.5rem] lg:mt-[-30px] md:mt-[-20px] p-4">
      ...
      @if (auth()->user()->hasRole(['super_admin']))
        <ul
          class="flex flex-col p-4 md:p-0 mt-2 font-medium border border-gray-100 rounded-lg 
            ...
            whitespace-nowrap lg:ml-[350px] lg:mt-[-80px] md:mt-[-75px]">
          <li
